...
.no-available:hover > img{
    transform: none
}
.no-available .darken-bg{
    background-color: rgba(0,0,0,0.8) !important;
}
.no-available .darken-bg:hover{
    background-color: rgba(0,0,0,0.8) !important;
}
.coming-soon{
    font-size: .8rem;
