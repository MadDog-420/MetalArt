<template>
    <footer class="page-footer bg-dark text-white container-fluid px-2 p-md-1">
        <div class="row my-md-5">
            ...
            <div class="col col-12 col-sm-4 py-5 border-bottom">
                <ul>
                    <div class="row">
                        ...
                        <div class="col col-6 col-sm-12"><li class="my-auto"><router-link to="/" class="nav-link text-white">Aprende</router-link></li></div>
            ...
            <div class="col col-12 col-sm-4 px-4 py-5 border-bottom">
                <ul>
