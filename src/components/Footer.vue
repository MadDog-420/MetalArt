    ...
    <footer class="page-footer bg-dark text-white container-fluid px-2 p-md-1">
        <div class="row my-md-5 mx-0">
            <div class="col col-12 col-sm-4 text-center border-bottom">
                ...
                <p class="copyright text-center d-none d-sm-block">Copyright &copy; 2022</p>
            </div>
            <div class="col col-12 col-sm-3 py-5 border-bottom">
                <ul>
                    <div class="row">
            ...
            <div class="col col-12 d-sm-none pt-4">
                <p class="copyright text-center">Copyright &copy; 2022</p>
            </div>
        </div>
    </footer>
</template>
